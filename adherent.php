<?php
		...
		$req1 = 'SELECT DTFINADH FROm adherant WHERE USER = "' . $_SESSION["login"] . '"';
					$res = mysqli_query($con,$req1);
					$ligne1 = mysqli_fetch_array($res);
					$_SESSION['date'] = $ligne1['DTFINADH'];
					$datef = $_SESSION['date'];
		// //////////////////////////////////////////
?>
<!DOCTYPE html>
<html lang="en">
	...
	<body>
		...
		<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
			<a class="navbar-brand" href="adherent.php?page=accueil">Accueil</a>
			...
			<ul class="navbar-nav">
			  <li class="nav-item">
			    <a class="nav-link" href="adherent.php?page=prestation">Prestations</a>
			  </li>
			  <li class="nav-item">
			    <a class="nav-link" href="adherent.php?page=inscseance">Inscription séance</a>
			  </li>
			  <li class="nav-item">
			    <a class="nav-link" href="adherent.php?page=seanceperso">Mes séances</a>
			  </li>
			  <li class="nav-item">
			    <a class="nav-link" href="adherent.php?page=deconnexion">Déconnexion</a>
			  </li>
			</ul>
			</div>
		</nav>
			...
			<?php
				if(isset($_GET['page'])){
					switch($_GET['page']){
						...
						break;
						case 'inscseance' :
							include('inscseance.php');
						break;
						case 'seanceperso':
							include('seanceperso.php');
							break;
						case 'deconnexion' :

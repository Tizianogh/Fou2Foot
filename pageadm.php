...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  <a class="navbar-brand" href="pageadm.php?page=accueil">Accueil</a>
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
			<li class="nav-item">
        <a class="nav-link" href="pageadm.php?page=admin">Administration</a>
      </li>
			<li class="nav-item">
        <a class="nav-link" href="pageadm.php?page=deconnexion">Déconnexion</a>
      </li>
    </ul>
  </div>
</nav>
...
<div class="container" style="margin-top:30px">
    ...
    break;
    case 'admin' :
      echo '  <h3 class="font-weight-bold text-center text-uppercase mb-4">Panel administration</h5>';
